    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back, color: CoresApp.azulBrapi2),
        ),

        bottom: PreferredSize(
          preferredSize: const Size.fromHeight(3),
          child: BarraTecnologica(color: CoresApp.azulBrapi2),
        ),
      ),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.terminal, color: CoresApp.azulBrapi2),
                ),
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: CoresApp.azulBrapi2.withOpacity(0.4)),
        ),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: const [
            Icon(Icons.search, size: 50, color: CoresApp.azulBrapi2),
            SizedBox(height: 15),
            ...
            Text(
              ...
              style: TextStyle(color: CoresApp.textoBranco70, fontSize: 13),
            ),
          ],
        ),
      ),
